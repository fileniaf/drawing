...
O package não possui dependências externas. Se adicionares futuras dependências, inclui-as em requirements.txt ou em [project.dependencies] no pyproject.toml.
